...
| crafting クラフト素材 | 表 | 112 | **112/112 ✅** | 95/112 | 宝石53(Shiny含)/鉱石8/精錬8/木材10/石材8/繊維5/その他20。世界5分類(バレー/永遠の島/物語の谷/願い咲く牧場/ハニーグローの森)。mydreamlightvalley `/images/materials/`＋各wiki横断調査。種別グループ＋世界フィルタ（MaterialsTableと同UI）。画像なし17件(精錬系ほか)は⛏️表示 |
