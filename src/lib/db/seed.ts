...
const SEED_LOADERS: Record<string, () => Promise<{ default: Record<string, any>[] }>> = {
  ...
  crafting: () => import('../data/crafting.json'),
  flowers: () => import('../data/flowers.json'),
  hourglass: () => import('../data/hourglass.json'),
  companions: () => import('../data/companions.json'),
  mounts: () => import('../data/mounts.json'),
  snippets: () => import('../data/snippets.json'),
